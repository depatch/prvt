...
export default function ChatList({ setActiveChat, provider }: ChatListProps) {
  ...
  return (
    <div className={styles.chatList}>
      <h2>Chats</h2>
      <NewConversation onConversationCreated={handleConversationCreated} provider={provider} />
